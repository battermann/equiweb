module Bootstrap.Alt.Modal exposing
    ( view, config, Config
...
import Bootstrap.Alt.General.Internal exposing (ScreenSize(..), screenSizeOption)
import Bootstrap.Alt.Utilities.DomHelper as DomHelper
